...
#include <dt-bindings/clock/qcom,gcc-msm8956.h>
...
static struct clk_hw *gcc_msm8956_hws[] = {
	&gpll0_early_div.hw,
	&gpll6_early_div.hw,
};

static struct clk_regmap *gcc_msm8956_clocks[] = {
	[GPLL0] = &gpll0.clkr,
...
static const struct qcom_reset_map gcc_msm8956_resets[] = {
...
static const struct regmap_config gcc_msm8956_regmap_config = {
	.reg_bits	= 32,
	.reg_stride	= 4,
	.val_bits	= 32,
...
static struct gdsc *gcc_msm8956_gdscs[] = {
	[CPP_GDSC] = &cpp_gdsc,
	[JPEG_GDSC] = &jpeg_gdsc,
	[MDSS_GDSC] = &mdss_gdsc,
...
static const struct qcom_cc_desc gcc_msm8956_desc = {
	.config = &gcc_msm8956_regmap_config,
	.clks = gcc_msm8956_clocks,
	.num_clks = ARRAY_SIZE(gcc_msm8956_clocks),
	.resets = gcc_msm8956_resets,
	.num_resets = ARRAY_SIZE(gcc_msm8956_resets),
	.gdscs = gcc_msm8956_gdscs,
	.num_gdscs = ARRAY_SIZE(gcc_msm8956_gdscs),
	.clk_hws = gcc_msm8956_hws,
	.num_clk_hws = ARRAY_SIZE(gcc_msm8956_hws),
};

static int gcc_msm8956_probe(struct platform_device *pdev)
{
	struct regmap *regmap;

	regmap  = qcom_cc_map(pdev, &gcc_msm8956_desc);
	if (IS_ERR(regmap))
		return PTR_ERR(regmap);

	clk_alpha_pll_configure(&gpll3_early, regmap, &gpll3_early_config);

	return qcom_cc_really_probe(pdev, &gcc_msm8956_desc, regmap);
}

static const struct of_device_id gcc_msm8956_match_table[] = {
	{ .compatible = "qcom,gcc-msm8956" },
	{},
};

static struct platform_driver gcc_msm8956_driver = {
	.probe = gcc_msm8956_probe,
	.driver = {
		.name = "gcc-msm8956",
		.of_match_table = gcc_msm8956_match_table,
	},
};

static int __init gcc_msm8956_init(void)
{
	return platform_driver_register(&gcc_msm8956_driver);
}
core_initcall(gcc_msm8956_init);

static void __exit gcc_msm8956_exit(void)
{
	platform_driver_unregister(&gcc_msm8956_driver);
}
module_exit(gcc_msm8956_exit);

MODULE_DESCRIPTION("Qualcomm GCC MSM8956 Driver");
